...
public class OperatorPre {
	...
	public static void practice1() {// 모든 사람이 사탕을 골고루 나눠갖기
		...
		// 기본으로 갖춰져있기는 하지만 라이브러리에서 가져와야 하기 때문에
		// import를 이용해서 가지고 옴
		...
		System.out.println("캔디 총개수 : " + candies);
	...
	public static void practice3() {
		...
		System.out.printf("국어 영어 수학평균 점수는 : " + average);
	}
	...
	public static void method4() {
		...
		// 3 != 5  true 라고 표현
		// 3 != 3  false 라고 표현
		// true false 표현할 때 그 갑이 true false로 표현받기 위해서는
		// boolean을 사용해서 표현을 함
	...
	/* 실습문제 4번 응용
	 2개의 수를 키보드로 입력 받아 입력 받은 수가 모두 다르면 true
	 								  모두 같으면 false
	 * */
