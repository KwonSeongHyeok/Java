...
// 메서드
	...
	public void practice2() {
		...
		// new ArrayList<>()는 <>안에 자료형을 넣어도 되고 안넣어도 됨
	...
	public void practice4() {
		...
		for(String f : fruit) {
			// 만약 내가 찾는 과일과 이름이 똑같다면  찾았다~! 해주기
			if(f.equals(search)) {
				found = true;
				break;// 찾았기 때문에 이름이 똑같은지 확인하는 if문 탈출
			}
		}
		System.out.println(search +" 찾아습니까? " + (found ? "찾음" : "못찾음"));
	}
	...
	public void practice5() {
		...
		// 4 search 스캐너로 변경
		System.out.print("보고싶은 동물을 입력하세요 : ");
		...
		System.out.println(search + "이(가) " + (found ? "있음" : "없음"));
	}
