...
public class ClientEx {
	...
	private static final int SERVER_PORT = 12145; // 서버가 열어놓은 포트번호 서버 = 클라이너트 포트 같아야함
	...
	public static void main(String[] args) {
		...
		Thread serverThread = new Thread(() -> {
			// 서버에서 방문자한테 메세지를 보내는 값으로 처음에는 아무 대화도 없기 때문에 null
			ServerToClientThread serverToClientThread = null;
			
			// 방문자가 서버한테 메세지를 보내는 값으로 처음에는 아무 대화도 없기때문에 null을 줌
